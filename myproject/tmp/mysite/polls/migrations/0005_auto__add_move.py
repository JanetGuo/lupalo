...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Move'
        db.create_table('polls_move', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Game'])),
            ('player', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('cell', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('tile', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('rotation', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('polls', ['Move'])


    def backwards(self, orm):
        # Deleting model 'Move'
        db.delete_table('polls_move')
