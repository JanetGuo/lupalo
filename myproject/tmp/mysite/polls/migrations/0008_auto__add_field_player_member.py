...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.member'
        db.add_column('polls_player', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Member'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.member'
        db.delete_column('polls_player', 'member_id')
